...
DashboardData MockDataGenerator::createDashboardData()
{
    ...
    data.runtimeSamples = {
        {0.0, 742.0, 36.5, 52.1, 112.0, 150.0, 180.0, 40.8},
        {5.0, 743.2, 37.4, 52.3, 115.0, 150.0, 180.0, 41.0},
        {10.0, 744.8, 38.6, 52.5, 118.0, 150.0, 180.0, 41.4},
        {15.0, 746.4, 39.5, 52.8, 120.0, 150.0, 180.0, 41.7},
        {20.0, 747.0, 40.1, 53.0, 122.0, 150.0, 180.0, 42.2},
        {25.0, 746.2, 39.7, 52.7, 119.0, 150.0, 180.0, 42.4},
        {30.0, 745.1, 38.9, 52.6, 117.0, 150.0, 180.0, 42.1},
        {35.0, 744.3, 37.8, 52.4, 114.0, 150.0, 180.0, 41.9},
        {40.0, 743.9, 37.1, 52.2, 111.0, 150.0, 180.0, 41.6},
        {45.0, 744.6, 38.0, 52.4, 116.0, 150.0, 180.0, 41.8},
        {50.0, 745.7, 39.2, 52.6, 121.0, 150.0, 180.0, 42.3},
        {55.0, 746.5, 39.8, 52.8, 123.0, 150.0, 180.0, 42.7}
    };
